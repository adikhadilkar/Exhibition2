...
$feedbackQuery="insert into feedback (id,subject,message,email,createdOn)  values('','$subject','$feedback','$emailId','$createdOn')";
$addFeedback=mysql_query($feedbackQuery,$conn) or die(mysql_error());
	
$jsonresponse=$emailId;			
deliver_response(200,"feedback added","Feedback",$jsonresponse);
